      ...
      <div id="bulb-tip-modal" className="modal-tip-dialog " role="tooltip">
        <div className="modal-tip-content">
          <div className="modal-tip-header">
            <div id="bulb-tip-closer" title="Close" className="close-tip">
              <IoClose />
            </div>
          </div>
          <div className="modal-tip-body">
            ...
            <p>
              ...
              progression, i.e.- how long you've stayed in each job, your growth
              and promotions, whether you've worked for similar companies and
              whether you have gaps in employment.
            </p>
            <ul className="list-tips">
              ...
              <li>
                Include start and end dates for each position. Leaving off dates
                will make employers think you're hiding something.
              </li>
              <li>
